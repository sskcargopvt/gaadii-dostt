-- Real-Time Booking Broadcast Trigger
...
-- 4. Table is already in supabase_realtime publication ✅
-- (Skip this step - table already configured)

-- 5. RLS policies for realtime access
...
CREATE POLICY IF NOT EXISTS "Users can subscribe to their bookings"
ON realtime.messages 
FOR SELECT 
TO authenticated
...
-- Expected output: Should show the trigger on booking_requests table
